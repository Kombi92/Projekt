...
namespace Projekt.Controllers
{
    public class UczenController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Imie,Nazwisko,DataZapisu,Stopien,Preferencje,Lekcja_Id")] Uczen uczen)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Imie,Nazwisko,DataZapisu,Stopien,Preferencje,Lekcja_Id")] Uczen uczen)
        {
            if (ModelState.IsValid)
            {
